...
EvtScript EVS_HandleEvent = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(EVENT_HIT)
            ...
            SetConst(LVar1, ANIM_CalamityKammy_Idle) // Hurt
        ...
        CaseEq(EVENT_DEATH)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_CalamityKammy_Idle) // Hurt or optional Death
            ExecWait(EVS_Enemy_Hit)
            Wait(10)
            ExecWait(EVS_Death)
            Return
...
EvtScript EVS_Attack_DropBlock = {
    ...
    // Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_BattleKammy_Anim07) // Spell Chant/Cast
    // Wait(5)
    ...
    Add(LVar1, 200)
    Add(LVar2, 2)
    Call(MakeEntity, Ref(Entity_Hammer3Block), LVar0, LVar1, LVar2, 0, MAKE_ENTITY_END)
    Set(LVar9, LVar0)
    Call(BlockAppear)
    Thread
    ...
    // EndLoop
    // Wait(20)
    // Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_BattleKammy_Anim08) // Drop Block
    // Wait(10)
    Call(UseBattleCamPreset, BTL_CAM_REPOSITION)
    ...
    EndChildThread
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CalamityKammy_Idle)
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
...
EvtScript EVS_Death = {
    ...
    Call(MoveBattleCamOver, 60)
    Wait(10)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CalamityKammy_Idle) // Hurt?
    // Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    // Sub(LVar2, 1)
    ...
    // Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_BattleKammy_Anim03) // KO
    Wait(50)
