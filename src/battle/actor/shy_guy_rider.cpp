...
#include "battle/common/newactor/boss_common.hpp"
...
EvtScript EVS_Attack_ArrowShot = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Call(PlaySoundAtPart, ACTOR_SELF, PRT_ARROW, SOUND_SPEAR_THROW)
            // Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            // Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Call(GetActorPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
            Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Call(SetPartMoveSpeed, ACTOR_SELF, PRT_ARROW, Float(10.0))
            Call(SetGoalToTarget, ACTOR_SELF)
            // Call(FlyPartTo, ACTOR_SELF, PRT_ARROW, LVar0, LVar1, LVar2, 0, 0, EASING_LINEAR)
            Call(SetPartJumpGravity, ACTOR_SELF, PRT_ARROW, Float(0.01))
            Call(JumpPartTo, ACTOR_SELF, PRT_ARROW, LVar0, LVar1, LVar2, 0, true)
            Wait(2)
